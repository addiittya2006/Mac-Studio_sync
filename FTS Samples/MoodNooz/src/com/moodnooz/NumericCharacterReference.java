...
/**
 * 
 * Helper class to encode/decode Strings with Numeric Character References as
 * defined in SGML.
 * 
 * @author franz.willer
 * 
...
public class NumericCharacterReference {
	 ...
	 * 
	 * @param str
	 *            A NCR encoded String
	 * @param unknownCh
	 *            , A character that is used if nnnn of &#nnnn; is not a int.
	 * 
	 ...
	 * <p>
	 * Formats each character < 0x20 or > 0x7f to &#nnnn; where nnnn is the char
	 * value as int.
	 * <p>
	 * 
	 * @param str
